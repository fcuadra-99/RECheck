...
type RecommendedActions = {
  suspendStudy: boolean;
  withdrawEthicalClearance: boolean;
  mitigationPlan: boolean;
  amendProtocol: boolean;
  upholdEthicalClearance: boolean;
};

export default function EthicsStudyReportableNegativeEventReport({
  protocolCode,
  researcherName,
  proposalTitle,
  proposalId,
  ...
  const [negativeEventsParticipants, setNegativeEventsParticipants] = useState<string>(s.negativeEventsParticipants ?? "");
  const [negativeEventsStudyTeam, setNegativeEventsStudyTeam] = useState<string>(s.negativeEventsStudyTeam ?? "");
  const [negativeEventsDataSafety, setNegativeEventsDataSafety] = useState<string>(s.negativeEventsDataSafety ?? "");
  const [actionsTaken, setActionsTaken] = useState<string>(s.actionsTaken ?? "");
  ...
  const [qActionsEnough, setQActionsEnough] = useState<YesNo>(s.qActionsEnough ?? "");
  const [recommendedActions, setRecommendedActions] = useState<RecommendedActions>(
    s.recommendedActions ?? {
      suspendStudy: false,
      withdrawEthicalClearance: false,
      mitigationPlan: false,
      amendProtocol: false,
      upholdEthicalClearance: false,
    }
  );
  ...
  const toggleRecommendedAction = (key: keyof RecommendedActions) => {
    const next = { ...recommendedActions, [key]: !recommendedActions[key] };
    setRecommendedActions(next);
    save({ recommendedActions: next });
  };
  ...
  return (
    <div>
      <div style={pageContainer}>
            ...
            <tr>
              ...
              <td style={headerRightCell}>
                <table style={controlBoxTable}>
                  <tbody>
                    <tr>
                      <td style={controlLabelCell}>REC_FO_0021</td>
                    </tr>
                    <tr>
        ...
        <div style={formTitle}>Ethics Study Reportable Negative Event Report</div>
        ...
        <table style={formTable}>
          <tbody>
            ...
            <tr>
              <td colSpan={4} style={sectionHeaderCell}>Reportable Negative Event Report</td>
            </tr>
            <tr>
            ...
            <tr>
              <td colSpan={2} style={fieldCellLargeLeft}>
                <strong>5. </strong>Description of Negative (harms, risks) Events
                <div style={subItemLabel}>a. Involving Participants</div>
                <textarea
                  style={blockTextarea}
                  value={negativeEventsParticipants}
                  onChange={(e) => {
                    setNegativeEventsParticipants(e.target.value);
                    save({ negativeEventsParticipants: e.target.value });
                  }}
                  onInput={autoExpand}
                />
                <div style={subItemLabel}>b. Involving members of the Study Team</div>
                <textarea
                  style={blockTextarea}
                  value={negativeEventsStudyTeam}
                  onChange={(e) => {
                    setNegativeEventsStudyTeam(e.target.value);
                    save({ negativeEventsStudyTeam: e.target.value });
                  }}
                  onInput={autoExpand}
                />
                <div style={subItemLabel}>c. Involving Data safety and Integrity</div>
                <textarea
                  style={blockTextarea}
                  value={negativeEventsDataSafety}
                  onChange={(e) => {
                    setNegativeEventsDataSafety(e.target.value);
                    save({ negativeEventsDataSafety: e.target.value });
                  }}
                  onInput={autoExpand}
                />
              </td>
              <td colSpan={2} style={fieldCellLargeRight}>
                <strong>6. </strong>Actions Taken to prevent future RNEs, interventions and Outcomes
                <textarea
                  style={largeTextarea}
                  value={actionsTaken}
                  onChange={(e) => {
                    setActionsTaken(e.target.value);
                    save({ actionsTaken: e.target.value });
                  }}
                  onInput={autoExpand}
                />
              </td>
      ...
      <div style={pageContainer}>
        ...
        <table style={formTable}>
          <tbody>
            ...
            <tr>
              <td colSpan={2} style={fieldCell}>Will the negative event/s lead to further risks/discomfort to the participants?</td>
              <td style={yesNoCell}>
                <label>
                  <input
                    type="radio"
                    checked={qRisksDiscomfort === "yes"}
                    onChange={() => {
                      setQRisksDiscomfort("yes");
                      save({ qRisksDiscomfort: "yes" });
                    }}
                    style={radioStyle}
                  />
                  Yes
              ...
              <td style={yesNoCell}>
                <label>
                  <input
                    type="radio"
                    checked={qRisksDiscomfort === "no"}
                    onChange={() => {
                      setQRisksDiscomfort("no");
                      save({ qRisksDiscomfort: "no" });
                    }}
                    style={radioStyle}
                  />
                  No
            ...
            <tr>
              <td colSpan={2} style={fieldCell}>Is there a favorable balance of risks and benefits?</td>
              <td style={yesNoCell}>
                <label>
                  <input
                    type="radio"
                    checked={qRiskBenefitBalance === "yes"}
                    onChange={() => {
                      setQRiskBenefitBalance("yes");
                      save({ qRiskBenefitBalance: "yes" });
                    }}
                    style={radioStyle}
                  />
                  Yes
              ...
              <td style={yesNoCell}>
                <label>
                  <input
                    type="radio"
                    checked={qRiskBenefitBalance === "no"}
                    onChange={() => {
                      setQRiskBenefitBalance("no");
                      save({ qRiskBenefitBalance: "no" });
                    }}
                    style={radioStyle}
                  />
                  No
            ...
            <tr>
              <td colSpan={2} style={fieldCell}>Are the actions taken enough and appropriate?</td>
              <td style={yesNoCell}>
                <label>
                  <input
                    type="radio"
                    checked={qActionsEnough === "yes"}
                    onChange={() => {
                      setQActionsEnough("yes");
                      save({ qActionsEnough: "yes" });
                    }}
                    style={radioStyle}
                  />
                  Yes
              ...
              <td style={yesNoCell}>
                <label>
                  <input
                    type="radio"
                    checked={qActionsEnough === "no"}
                    onChange={() => {
                      setQActionsEnough("no");
                      save({ qActionsEnough: "no" });
                    }}
                    style={radioStyle}
                  />
                  No
            ...
            <tr>
              <td colSpan={4} style={fieldCellBig}>
                ...
                <label style={checkLine}>
                  <input
                    type="checkbox"
                    checked={recommendedActions.suspendStudy}
                    onChange={() => toggleRecommendedAction("suspendStudy")}
                    style={checkStyle}
                  />
                  recommend suspension of the study until the risk is resolved.
                </label>
                <label style={checkLine}>
                  <input
                    type="checkbox"
                    checked={recommendedActions.withdrawEthicalClearance}
                    onChange={() => toggleRecommendedAction("withdrawEthicalClearance")}
                    style={checkStyle}
                  />
                ...
                <label style={checkLine}>
                  <input
                    type="checkbox"
                    checked={recommendedActions.mitigationPlan}
                    onChange={() => toggleRecommendedAction("mitigationPlan")}
                    style={checkStyle}
                  />
                ...
                <label style={checkLine}>
                  <input
                    type="checkbox"
                    checked={recommendedActions.amendProtocol}
                    onChange={() => toggleRecommendedAction("amendProtocol")}
                    style={checkStyle}
                  />
                ...
                <label style={checkLine}>
                  <input
                    type="checkbox"
                    checked={recommendedActions.upholdEthicalClearance}
                    onChange={() => toggleRecommendedAction("upholdEthicalClearance")}
                    style={checkStyle}
                  />
...
const fieldCellLargeLeft: React.CSSProperties = {
  border: "1px solid black",
  padding: "6px",
  verticalAlign: "top",
  minHeight: "180px",
...
const fieldCellLargeRight: React.CSSProperties = {
  border: "1px solid black",
  padding: "6px",
  verticalAlign: "top",
  minHeight: "180px",
