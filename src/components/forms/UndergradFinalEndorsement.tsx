            ...
            <tr>
              ...
              <td style={{ 
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td style={{ fontWeight: 'bold', verticalAlign: 'top' }}>
                        UIC-REC Endorsement for Final Defense
                      </td>
                    </tr>
                  </tbody>
                </table>
                ...
                <div style={{ marginBottom: '10px', lineHeight: '1.8' }}>
                  This is to acknowledge receipt of the following supporting document/s{' '}
                  <input 
                    type="text" 
                    name="receiptDate"
                ...
                <div style={{ marginBottom: '20px', textAlign: 'justify', lineHeight: '1.8' }}>
                  ...
                  approves and releases the Endorsement for Final Defense for your study titled: 
                  <textarea 
                    name="title"
                    value={formData.title}
                    onChange={handleChange}
            ...
            <tbody>
              <tr>
                <td style={{ width: '75%', fontSize: '7pt', textAlign: 'center', lineHeight: '1.3' }}>
                  ...
                  <b>Pacific (UMAP) • Association of Southeast and East Asian Catholic Colleges and Universities (ASEACCU)</b>
                </td>
