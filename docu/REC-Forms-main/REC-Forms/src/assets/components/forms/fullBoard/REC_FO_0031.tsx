...
function EthicsInformedConsentFormSample() {
  ...
  const [participantDateSigned, setParticipantDateSigned] = useState("");
  const [consentObtainerName, setConsentObtainerName] = useState("");
  const [consentObtainerDateSigned, setConsentObtainerDateSigned] =
    useState("");
  ...
  return (
    <div style={container}>
      ...
      <textarea
        ...
        onInput={autoExpand}
        placeholder="Enter contact numbers, email addresses, and office/location details."
      />
