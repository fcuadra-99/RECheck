...
function EthicsStudyProtocolInformationForm() {
  ...
  return (
    <div style={container}>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style={tdInput}>
              <textarea
                style={tableTextareaStyle}
                value={tablePrincipalInvestigator}
                onChange={(e) => setTablePrincipalInvestigator(e.target.value)}
                onInput={autoExpand}
              />
            </td>
          </tr>
      ...
      <div style={preparedWrap}>
        <strong style={{ display: "block", marginBottom: "8px" }}>
          Prepared by
        </strong>
        <textarea
          style={preparedByInput}
          value={preparedBy}
          onChange={(e) => setPreparedBy(e.target.value)}
          onInput={autoExpand}
        />
        <div style={preparedLabel}>Signature over Printed Name</div>
      </div>
